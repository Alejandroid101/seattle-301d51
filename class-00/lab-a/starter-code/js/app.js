...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: The scope was not finding "rando" because of the corresponding block it was in. console.log was declared outside that block therefore it was unable to find
  console.log(viewed);
