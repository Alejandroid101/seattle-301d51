...
//I think it is referring back to the object creator "Student"
// 2. What is "this" when joe.scopeArrow() is invoked?
//i honestly don't know :(
// 3. Explain why "this" is different when an arrow function is used.
//Based on what i read in the MDN site, the arrow function, it is not binding to this, arguments and super (which again, I don't know what those are). What i get from this is that arrow functions have no "this"
